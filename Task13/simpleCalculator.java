...
public class simpleCalculator extends JFrame implements MouseListener, ActionListener {
    ...
    simpleCalculator() {
        ...
        JPanel operatorPanel = new JPanel();
            operatorPanel.setLayout(new GridLayout(3, 1));
...
public class simpleCalculator extends JFrame implements MouseListener, ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            JOptionPane.showMessageDialog(jFrame, "Angka Tidak boleh kosong");
        }
    ...
    public static void main(String[] args) {
        simpleCalculator kalkulator = new simpleCalculator();
    }
