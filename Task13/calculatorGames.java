...
public class calculatorGames extends JFrame implements MouseListener, ActionListener {
    ...
    public static void main(String[] args) {
        calculatorGames kalkulator = new calculatorGames();
    }
